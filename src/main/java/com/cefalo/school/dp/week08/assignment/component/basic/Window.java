 ...
 */
public class Window extends Component implements Buildable{

  public Window(String type, Dimensions dimensions, String materials) {
  ...
  public void validate() throws WrongArchitectureException {
    if(StringUtils.isBlank(type)) {
      throw new WrongArchitectureException("The Window type must be defined.");
    }

    if(!MeasurementValidator.validateDimensions(dimensions)) {
      throw new WrongArchitectureException("The Window dimension is invalid.");
    }

    if(StringUtils.isBlank(materials)) {
      throw new WrongArchitectureException("The Window materials must be defined.");
    }
  }
}
